...
fun WeatherDetails(weatherData: WeatherModel) {
    Column(
        ...
        Row(
            ...
            Text(text = weatherData.location.country, fontSize = 18.sp, color = Color.Gray)
        ...
        Card(modifier = Modifier.padding(bottom = 20.dp)) {
            Column(modifier = Modifier.fillMaxWidth()) {
                ...
                Row(
                    ...
                    WeatherKeyVal(key = "UV Inded", value = weatherData.current.uv)
    ...
    Box(
        ...
        Column(
            ...
            OutlinedTextField(
                ...
                label = { Text(text = "Search for any location", color = Color.White) },
